          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                Lx Group is a leading provider of sustainable and innovative power solutions, dedicated to meeting the evolving needs of our clients with a focus on reliability, efficiency, and environmental responsibility.
              </p>
              <div className="-mx-3 flex items-center">
                <a
                  aria-label="Facebook"
                  href="https://www.facebook.com/lxpowergroup"
                  target="_blank"
                ...
                <a
                  aria-label="Twitter"
                  href="https://twitter.com/lxpowergroup"
                  target="_blank"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                ...
                <a
                  aria-label="LinkedIn"
                  href="https://www.linkedin.com/company/lxpowergroup"
                  target="_blank"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                ...
                <a
                  ...
                  href="https://www.instagram.com/lxpowergroup"
                  target="_blank"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
              ...
              <ul>
                ...
                <li>
                  <Link
                    ...
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    High & Low Voltage Electrical Panels
                  </Link>
                </li>
                <li>
                  <Link
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  ...
                  <a
                    href="https://evleaf.in"
                    rel="nofollow noopner noreferrer"
                    target="_blank"
                    className="text-gray-1 hover:underline"
                  >
                    Evleaf Group of Company
                  </a>
                </p>
              </div>
            </div>
